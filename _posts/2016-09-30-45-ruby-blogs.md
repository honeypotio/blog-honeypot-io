...
Ruby was developed in the mid-1990s by [Yukihiro Matsumoto](https://twitter.com/yukihiro_matz?lang=en), as an objecting-oriented scripting language, which was more robust and flexible than either Python or Perl. The release of the Rails framework in 2004 catapulted Ruby to fame outside Japan and since then a passionate open-source community has developed. Today the language is used in production at many tech companies.
...
On Honeypot, companies apply directly to developers with salary and tech stack upfront. **[Sign up today](https://app.honeypot.io/users/sign_up?ruby-blog)** and start getting offers directly in your inbox!