...
categories: [HR Tips]
cover_image: reverse-recruitment.png
...
As reverse recruitment puts the developer in a central spot by letting companies apply to them, **the majority of developers use these platforms over other channels**. So how can you use reverse recruitment to optimise your tech recruitment KPIs? Read on to find out!
...
Let’s see an example – and feel free to follow the steps with one of your open positions.
